...
And you can run it via:
	...
	polylint -i paper-input-matrix.html
...
`http://localhost:8080/components/paper-input-matrix/`, where `paper-input-matrix` is the name of the directory containing it.


## Testing Your Element

Simply navigate to the `/test` directory of your element to run its tests. If
you are using Polyserve: `http://localhost:8080/components/paper-input-matrix/test/`
